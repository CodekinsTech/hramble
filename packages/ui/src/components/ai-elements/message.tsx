	...
	({ className, ...props }: MessageResponseProps) => (
		<Streamdown
			className={cn(
				...
				"[&_h1]:mt-4 [&_h1]:mb-1.5 [&_h1]:text-lg [&_h1]:font-semibold",
				...
				"[&_li]:my-0.5 [&_li]:leading-6 [&_li]:pl-0.5 [&_li>ul]:my-0.5 [&_li>ol]:my-0.5",
				...
				"[&_strong]:font-semibold [&_blockquote]:my-3 [&_blockquote]:border-l-2 [&_blockquote]:border-border [&_blockquote]:pl-3 [&_blockquote]:text-muted-foreground",
