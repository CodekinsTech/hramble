/**
 * Lockfile for the Hramble-managed OpenCode server process.
 *
 * Written when Hramble spawns a server, removed on clean shutdown. On next
 ...
 *
 * Path: ~/.local/share/hramble/server.lock
 */
