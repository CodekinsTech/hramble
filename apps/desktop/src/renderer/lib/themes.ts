...
// Key traits:
//   - Neutral (cool) grays
//   - Hramble Blue accent (#05bdf5 base, oklch 228.71 hue)
...
export const cortexTheme: ThemeDefinition = {
	id: "cortex",
	name: "Cortex",
	description: "Cool neutrals with Hramble Blue accent, clean and minimal",
	cssVars: {
		light: {
...
//     Hramble Blue fallbacks, so they track the OS accent color
