// Local copy of the engine/OpenCode domain types (Session, Message, Part, Event,
// etc.). Vendored so the app's type system no longer depends on @opencode-ai/sdk.
// Types only — erased at build. Generated shape; kept verbatim for exactness.
/* eslint-disable */
// biome-ignore-all lint: vendored generated types
