...
function LoginGate() {
	...
	return (
		<div className="flex h-full flex-col items-center justify-center gap-4 px-6 text-center">
			...
			<div>
				<h1 className="text-foreground text-xl" style={{ fontFamily: "'Karmatic Arcade', sans-serif" }}>Wired Jack</h1>
		...
		<div className="flex h-full flex-col overflow-y-auto">
			<div className={embedded ? "w-full flex-1 px-4 py-4" : "mx-auto w-full max-w-lg flex-1 px-4 py-6"}>
				<div className="mb-4 flex items-center justify-between">
					<div className="flex items-center gap-2">
						<h1 className="text-foreground text-lg" style={{ fontFamily: "'Karmatic Arcade', sans-serif" }}>Wired Jack</h1>
						{filterTag && (
